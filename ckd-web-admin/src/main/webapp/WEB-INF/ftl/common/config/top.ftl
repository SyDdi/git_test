      ...
      <div class="container" style="padding-left: 0px; padding-right: 0px;">
        <div class="navbar-header">
	     ...
	     <div role="navigation" class="navbar-collapse collapse">
	     		<a id="_logo"  href="#" style="color:#fff; font-size: 24px;" class="navbar-brand hidden-sm">行情价后台管理系统 演示</a>
				...
				<@shiro.hasAnyRoles name='888888,100003'>
				  ...
				  <@shiro.hasAnyRoles name='888888,100001,100002,100003'>
					  <li class="dropdown ${(index==4)?string('active','')}">
						  <a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown" class="dropdown-toggle" href="${basePath}/vehiclemanage/init.shtml">
							  车辆管理<span class="caret"></span>
						  </a>
						  <ul class="dropdown-menu">
							  <@shiro.hasPermission name="/vehiclemanage/init.shtml">
								  <li><a href="${basePath}/vehiclemanage/init.shtml">车辆管理</a></li>
							  </@shiro.hasPermission>
						  </ul>
					  </li>
				  </@shiro.hasAnyRoles>
	           ...
	           <ul class="nav navbar-nav  pull-right" >
				<li class="dropdown ${(index==10)?string('active','')}" style="color:#fff;">
					<a aria-expanded="false" aria-haspopup="true"  role="button" data-toggle="dropdown"  
						<@shiro.user>  
							onclick="location.href='../../../../user/index.shtml'" href="${basePath}/user/index.shtml" class="dropdown-toggle qqlogin" >
