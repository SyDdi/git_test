package com.car.web.admin.core.statics;

import com.car.web.admin.core.config.IConfig;
import com.car.web.admin.utils.DateUtil;
...
public interface Constant {
	...
	static final String DOMAIN_IMG = IConfig.get("domain.img");//图片域名
	static String VERSION = DateUtil.dateToStringWithTime();//版本号，重启的时间
	static final String weixinURL = IConfig.get("weixinURL");//微信域名
	
	//存储到缓存，标识用户的禁止状态，解决在线用户踢出的问题
	final static String  EXECUTE_CHANGE_USER = "CARKING_EXECUTE_CHANGE_USER";
}
